  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        />
         <CheckBoxText
            label="I would like a team member from 7000 Languages to follow up with you about creating additional resources for my language."
        />
        <Text style={styles.selectingText}>{`By selecting this button, you confirm you have permission from\n the community/speakers to create language learning materials.`}</Text>
